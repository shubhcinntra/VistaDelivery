...
public class SalesEmployeeAutoAdapter extends ArrayAdapter<SalesEmployeeItem> {
    Context context;
    int resourceId;
    List<SalesEmployeeItem> items;

    public SalesEmployeeAutoAdapter(@NonNull Context context, int resourceId, List<SalesEmployeeItem> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        name.setText(model.getSalesEmployeeName());
        return view;
    }
