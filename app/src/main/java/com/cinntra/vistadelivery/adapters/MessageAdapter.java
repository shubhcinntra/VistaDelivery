...
public class MessageAdapter extends RecyclerView.Adapter<com.cinntra.vistadelivery.adapters.MessageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.cinntra.vistadelivery.adapters.MessageAdapter.ViewHolder(rootView);
    }
