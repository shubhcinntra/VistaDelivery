...
public class QuotationOneAPiModel implements Serializable {
    @SerializedName("data")
    ...
    public class Data implements Serializable{
        ...
        @SerializedName("CompanyBranchDetails")
        @Expose
        List<ResponseCompanyBranchAllFilter.Datum> CompanyBranchDetails;
        ...
        @SerializedName("AttachDetails")
        ArrayList<AttachDocument> AttachDetails;
...
//    String SalesPersonCode;
        ...
        public ArrayList<AttachDocument> getAttachDetails() {
            return AttachDetails;
        }

        public void setAttachDetails(ArrayList<AttachDocument> attachDetails) {
            AttachDetails = attachDetails;
        }

        public List<ResponseCompanyBranchAllFilter.Datum> getCompanyBranchDetails() {
            return CompanyBranchDetails;
        }

        public void setCompanyBranchDetails(List<ResponseCompanyBranchAllFilter.Datum> companyBranchDetails) {
            CompanyBranchDetails = companyBranchDetails;
        }
