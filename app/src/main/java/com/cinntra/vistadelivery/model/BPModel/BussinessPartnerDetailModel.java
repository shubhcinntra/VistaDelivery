...
public class BussinessPartnerDetailModel implements Serializable {
    ...
    public static class Datum implements Serializable {
        ...
        public ArrayList<DataBusinessType> U_TYPE;
        ...
        public DataDropDownZone getZoneDeatils() {
            return ZoneDeatils;
        }

        public void setZoneDeatils(DataDropDownZone zoneDeatils) {
            ZoneDeatils = zoneDeatils;
        }
        ...
        public void setU_TYPE(ArrayList<DataBusinessType> u_TYPE) {
            U_TYPE = u_TYPE;
        }

        public ArrayList<DataBusinessType> getU_TYPE() {
            return U_TYPE;
        }
