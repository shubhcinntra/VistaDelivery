...
public class QuotationList_ViewModel extends ViewModel {
    ...
    private void loadQuotation(ProgressBar loader) {
        ...
        Call<QuotationResponse> call = NewApiClient.getInstance().getApiService(loader.getContext()).OpenQuotationList(hd);
...
//        loadOrders(loader);
 ...
 /*   private void loadOrders(ProgressBar loader) {
        ...
        call = NewApiClient.getInstance().getApiService(this).OrdersList(hd);
