...
import com.cinntra.vistadelivery.adapters.MessageAdapter;
import com.cinntra.vistadelivery.databinding.LeadfollowupfragmentBinding;
...
//        callContactApi(opportunityItem.getCardCode());
    ...
    private void showBottomSheet(int id, String name) {
        ...
        ReminderSelectionSheet bottomSheetFragment = new ReminderSelectionSheet(id, name, com.cinntra.vistadelivery.fragments.LeadFollowUpFragment.this);
