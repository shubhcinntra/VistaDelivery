...
import com.cinntra.vistadelivery.adapters.BottomSheetAdapter;
...
//    CheckBox follow_up;
    ...
    private void callfollowupApi(FollowUpData followUpData)
        ...
        Call<FollowUpResponse> call = NewApiClient.getInstance().getApiService(requireContext()).createfollowUP(followUpData);
