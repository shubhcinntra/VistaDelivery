...
import com.cinntra.vistadelivery.activities.InvoiceItemList;
import com.cinntra.vistadelivery.adapters.SalesEmployeeAutoAdapter;
import com.cinntra.vistadelivery.databinding.InvoiceDetailBinding;
...
//        binding.quotationGeneralContent.img9.setVisibility(View.GONE);
        ...
        binding.quotationGeneralContent.edCreatedDate.setFocusable(false);
        binding.quotationGeneralContent.edCreatedDate.setClickable(false);
    ...
    public static com.cinntra.vistadelivery.fragments.Invoice_Detail_Fragment newInstance(String param1, String param2) {
        com.cinntra.vistadelivery.fragments.Invoice_Detail_Fragment fragment = new com.cinntra.vistadelivery.fragments.Invoice_Detail_Fragment();
...
//        binding.quotationGeneralContent.salesemployeeSpinner.setEnabled(false);
        ...
        salesPersonCode = quotationItem.getSalesPersonCode();
...
//          qt_status.setText(Globals.getStatus(quotationItem.getDocumentStatus()));
        ...
        binding.quotationGeneralContent.edCreatedDate.setText(quotationItem.getCreationDate());
        ...
        if (quotationItem.getAddressExtension().getBillToStreet() != null)
            binding.addressContent.invoiceaddressSection.billingNameValue.setText(quotationItem.getAddressExtension().getBillToStreet());
        if (quotationItem.getAddressExtension().getBillToBuilding() != null)
            binding.addressContent.invoiceaddressSection.billingAddressValue.setText(quotationItem.getAddressExtension().getBillToBlock());
        if (quotationItem.getAddressExtension().getBillToZipCode() != null)
            binding.addressContent.invoiceaddressSection.zipCodeValue.setText(quotationItem.getAddressExtension().getBillToZipCode());
        if (quotationItem.getAddressExtension().getShipToStreet() != null)
            binding.addressContent.invoiceaddressSection.shippingNameValue.setText(quotationItem.getAddressExtension().getShipToStreet());
        if (quotationItem.getAddressExtension().getShipToBuilding() != null)
            binding.addressContent.invoiceaddressSection.shippingAddressValue.setText(quotationItem.getAddressExtension().getShipToBlock());
        if (quotationItem.getAddressExtension().getShipToBuilding() != null)
            binding.addressContent.invoiceaddressSection.zipcodeValue2.setText(quotationItem.getAddressExtension().getShipToBuilding());
        if (quotationItem.getAddressExtension().getU_BSTATE() != null)
            binding.addressContent.invoiceaddressSection.stateValue.setText(quotationItem.getAddressExtension().getU_BSTATE());
        if (quotationItem.getAddressExtension().getU_BCOUNTRY() != null)
            binding.addressContent.invoiceaddressSection.countryValue.setText(quotationItem.getAddressExtension().getU_BCOUNTRY());
        if (quotationItem.getAddressExtension().getU_SSTATE() != null)
            binding.addressContent.invoiceaddressSection.shipStateValue.setText(quotationItem.getAddressExtension().getU_SSTATE());
        if (quotationItem.getAddressExtension().getU_SCOUNTRY() != null)
            binding.addressContent.invoiceaddressSection.shipCountryValue.setText(quotationItem.getAddressExtension().getU_SCOUNTRY());
        ...
        salePCode = String.valueOf(quotationItem.getContactPersonCode());
