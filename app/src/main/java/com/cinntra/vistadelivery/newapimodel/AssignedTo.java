...
public class AssignedTo implements Parcelable {
    ...
    public final static Creator<AssignedTo> CREATOR = new Creator<AssignedTo>() {
        ...
        public com.cinntra.vistadelivery.newapimodel.AssignedTo createFromParcel(android.os.Parcel in) {
            return new com.cinntra.vistadelivery.newapimodel.AssignedTo(in);
        }

        public com.cinntra.vistadelivery.newapimodel.AssignedTo[] newArray(int size) {
            return (new com.cinntra.vistadelivery.newapimodel.AssignedTo[size]);
        }
